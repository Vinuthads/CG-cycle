...
void motion(int x,int y)
{
   if(Mouse==GLUT_DOWN)
   {
      ...
      if(deltax!=0 && deltay!=0)
         anglez += 0.5*sqrt((double)(deltax*deltax + deltay*deltay));
      if(anglex < 0)
         anglex+=360.0;
      if(angley < 0)
         angley+=360.0;
...
void help(void)
{
    ...
    printf(" |===========================================================|\n");
    printf(" #--Computer Graphics Mini Project:-'3D Bicycle Simulation'--#\n");
	printf(" |====>Vinutha D S(1SG19CS122) VidyaKrishna(1SG19CS120)<====|\n");
    printf(" |-----------------------------------------------------------|\n");

   cout<<"         Use the following shortcuts to move the Bicycle..."<<endl;
   cout<<"          _________________"<<endl;
   cout<<"         |'+' to increase the speed                      |"<<endl;
   cout<<"         |'-' to decrease the speed                      |"<<endl;
   cout<<"         |'b' to rotate the handle clockwise             |"<<endl;
   cout<<"         |'z' to rotate the handle anti-clockwise        |"<<endl;
   cout<<"         |'s' or 'S' to reset the scene                  |"<<endl;
...
int main(int argc,char *argv[])
{
   ...
   glutCreateWindow("3D Bicycle Simulation");
